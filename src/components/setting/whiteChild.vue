      ...
      <div class="whiteItem" @click="addShow" v-show="WhiteList.length === 0">
        ...
        <span style="text-align: right;">
          <span style="line-height:20px; padding:5px 0;color: #aeaeae;">
            <p
              v-if="deletesLength == 0 || (deletesLength == 1 && numId !=10)||(deletesLength == 2 && numId < 9)||(deletesLength == 3 && numId < 8)||(deletesLength == 4 && numId < 7)||(deletesLength == 5 && numId < 6)||(deletesLength == 6 && numId < 5)||(deletesLength == 7 && numId < 4) || (deletesLength == 8 && numId < 3) || (deletesLength == 9 && numId < 2) || (deletesLength == 10 && numId < 1)">
